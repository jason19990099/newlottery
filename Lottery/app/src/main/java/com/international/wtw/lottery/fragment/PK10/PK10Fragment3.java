...
public class PK10Fragment3 extends BetBaseFragment implements BetItemAdapter.ItemBettingCallback, StateInterface {
    private View view;
    private boolean IsFeng;
    private BetItemAdapter adapter;
    private List<View> ydwdTopItemView = new ArrayList<View>();    //一~五名
    private int currentPlayTypeCode = Constants.PK_10_PLAY_TYPE_SERVER.ONE_TO_FIVE;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.view_ydwh, null);
    ...
    private void initView() {
        ...
        ydwdTopItemView.add(view.findViewById(R.id.layout_ydwh_one));
        ydwdTopItemView.add(view.findViewById(R.id.layout_ydwh_two));
        ydwdTopItemView.add(view.findViewById(R.id.layout_ydwh_three));
        ydwdTopItemView.add(view.findViewById(R.id.layout_ydwh_four));
        ydwdTopItemView.add(view.findViewById(R.id.layout_ydwh_five));
            ...
            if (null != getActivity()) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        adapter = new BetItemAdapter(oneBean.getList(), getActivity(), PK10Fragment3.this, IsFeng);
