...
public class SettledOrderAdapter extends BaseAdapter {
  ...
  public  SettledOrderAdapter(Context context,List<SettledOrdersModel.DataBeanX.DataBean> data){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        viewHolder.tv_win_money.setText(String.valueOf(data.get(position).getAmount())+"元");
        viewHolder.tv_bet_money.setText(String.valueOf(data.get(position).getWinLoseAmount())+"元");
        return view;
    }
