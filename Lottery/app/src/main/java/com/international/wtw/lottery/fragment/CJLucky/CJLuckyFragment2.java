...
public class CJLuckyFragment2 extends BetBaseFragment implements BetItemAdapter.ItemBettingCallback, StateInterface {
    private View view;
    //一到四
    private List<View> oneToFourTopItemView = new ArrayList<View>();
            ...
            if (null != getActivity()) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        BetItemAdapter adapter = new BetItemAdapter(oneBean.getList(), getActivity(), CJLuckyFragment2.this, IsFeng);
