...
public class CJLuckyFragment3 extends BetBaseFragment implements BetItemAdapter.ItemBettingCallback, StateInterface {
    private View view;
    //五到八
    private List<View> fiveToEightTopItemView = new ArrayList<>();
            ...
            if (null != getActivity()) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        BetItemAdapter adapter = new BetItemAdapter(oneBean.getList(), getActivity(), CJLuckyFragment3.this, IsFeng);
    ...
    private void getBettingData() {
        ...
        betParams.put("type_code", String.valueOf(Constants.GD_HAPPY_PLAY_TYPE.FIVE_TO_EIGHT));
